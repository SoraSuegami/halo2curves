...
impl group::cofactor::CofactorGroup for Curve25519 {
    type Subgroup = Curve25519;
...
const SECP_A: Fp = Fp::from_raw([0xaaaaaa984914a144,0xaaaaaaaaaaaaaaaa,0xaaaaaaaaaaaaaaaa,0x2aaaaaaaaaaaaaaa]);
const SECP_B: Fp = Fp::from_raw([0x260b5e9c7710c864, 0xed097b425ed097b4, 0x097b425ed097b425, 0x7b425ed097b425ed]);
...
#[macro_export]
macro_rules! new_a_b_curve_impl {
    (($($privacy:tt)*),
    $name:ident,
    $name_affine:ident,
    ...
    $curve_id:literal,
        ...
        impl CurveExt for $name {
            ...
            fn is_on_curve(&self) -> Choice {
                ...
                let z4 = z2.square();
                let z6 = z4 * z2;
                (self.y.square() - self.x.square() * self.x - $name::curve_constant_a() * self.x * z4)
        ...
        impl group::Group for $name {
            ...
            fn double(&self) -> Self {
                ...
                let x3_4 = x3.double().double();
                let a = a.double();
                let a = a.double();
                let a = a.double();
                let y3 = m * (s - x3) - a;
                let y3_8 = y3.double().double().double();
...
#[test]
fn test_curve() {
    crate::tests::curve::curve_tests::<Curve25519>();
}
